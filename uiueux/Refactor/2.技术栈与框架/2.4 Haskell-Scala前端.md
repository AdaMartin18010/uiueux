...
- [1.1 Web端](../1.终端类型/1.1%20Web端.md)：Web端与Haskell-Scala前端的类型安全与纯函数性对比。
- [2.1 前端主流框架](./2.1%20前端主流框架.md)：Haskell-Scala前端与主流JS框架的范式与工程实践对比。
- [2.3 Rust前端全栈](./2.3%20Rust前端全栈.md)：类型系统与函数式范式的跨语言比较。
- [2.5 WebAssembly](./2.5%20WebAssembly.md)：Haskell/Scala与WebAssembly的集成与性能分析。
- [4.1 GoF设计模式](../4.设计模式与架构/4.1%20GoF设计模式.md)：Haskell-Scala前端中的设计模式应用。
- [5.1 UI-UE-UX设计规范](../5.技术规范与标准/5.1%20UI-UE-UX设计规范.md)：Haskell-Scala前端对设计规范的支持与约束。
